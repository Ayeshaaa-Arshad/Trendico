...
class ProductTest(TestCase):
    def setUp(self):
        ...
        self.product = Product.objects.create(
            name='Laptop', price=1000.00, category=self.category, initial_quantity=10)
...
class ProductImageTest(TestCase):
    def setUp(self):
        ...
        self.image = ProductImage.objects.create(
            product=self.product, image='laptop.jpg')
...
class WishlistTest(TestCase):
    ...
    def test_string_representation(self):
        self.assertEqual(str(self.wishlist),
                         f'Wishlist of {self.user.username}')
